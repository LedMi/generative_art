...
def hexagon(x,y,c,k1:float, k2:float,k3:float, k4:float, k5:float,k6:float):
    ctx.move_to(x+0.35+c/10, y+0.13+c/10)
    ctx.line_to(x+0.35+c/10, y+0.13+c/10)
    ctx.line_to(x+0.425+c/10, y+0.18+c/10)
    ctx.line_to(x+0.425+c/10, y+0.27+c/10)
    ctx.line_to(x+0.35+c/10, y+0.32+c/10)
    ctx.line_to(x+0.275+c/10, y+0.27+c/10)
    ctx.line_to(x+0.275+c/10, y+0.18+c/10)
    ctx.close_path()

    ctx.set_source_rgb(k4, k5, k6)
    ctx.fill_preserve()
    ctx.set_source_rgb(k1, k2, k3)
    ctx.set_line_width(0.001)
    ctx.stroke()
...
for x in range(8):
    for y in range(1):
        for z in range(1):
            hexagon(x/10 -0.75,y/10-0.5, 1, 1, 1, 1, 0.5,0.25,0.25+x/16)
            hexagon(-x / 10 + 0.75 , -y / 10 + 0.5, 1, 1, 1, 1, 0.5, 0.25, 0.25+x/16)
...
surface.write_to_png("example23.png")  # Output to PNG
